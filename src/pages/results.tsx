...
const ResultRow:React.FC<{
    ...
    return (
        <div className="relative flex border-b p-2 items-center justify-between">
          ...
          <div className="absolute top-0 left-0 z-10 flex items-center justify-center px-2 font-semibold text-white bg-gray-600 border border-gray-500 shadow-lg rounded-br-md w-7">
            {props.rank}
          </div>
        </div>
      );
